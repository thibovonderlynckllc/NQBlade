        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12 mb-8 max-w-4xl mx-auto text-center">
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>
                <a href="#features" className="text-white/90 hover:text-[var(--color-primary-light)] transition-colors">
                  Features
                </a>
              </li>
              <li>
                <a href="#pricing" className="text-white/90 hover:text-[var(--color-primary-light)] transition-colors">
                  Pricing
                </a>
              </li>
              <li>
                <a href="#testimonials" className="text-white/90 hover:text-[var(--color-primary-light)] transition-colors">
                  Testimonials
                </a>
              </li>
              <li>
                <a href="#faq" className="text-white/90 hover:text-[var(--color-primary-light)] transition-colors">
                  FAQ
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>
                <a href="http://t.me/Marlon_NQBlade" target="_blank" rel="noopener noreferrer" className="text-white/90 hover:text-[var(--color-primary-light)] transition-colors">
                  Contact Us
                </a>
              </li>
              <li>
                <a href="#documentation" className="text-white/90 hover:text-[var(--color-primary-light)] transition-colors">
                  Documentation
                </a>
              </li>
              <li>
                <a href="#community" className="text-white/90 hover:text-[var(--color-primary-light)] transition-colors">
                  Community
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>
                <a href="#privacy" className="text-white/90 hover:text-[var(--color-primary-light)] transition-colors">
                  Privacy Policy
                </a>
              </li>
              <li>
                <a href="#terms" className="text-white/90 hover:text-[var(--color-primary-light)] transition-colors">
                  Terms of Service
                </a>
              </li>
              <li>
                <a href="#refund" className="text-white/90 hover:text-[var(--color-primary-light)] transition-colors">
                  Refund Policy
                </a>
              </li>
            </ul>
